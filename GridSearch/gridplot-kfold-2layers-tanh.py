...
def run(dataset):
    ...
    plt.savefig("Grid-kfold2-2layers-tanh-%depochs.png" %(epochs), dpi=300)
    # plt.legend(optimizer_list, bbox_to_anchor=(0, 0, 1, 1), bbox_transform=plt.gcf().transFigure)
    # plt.show()
  
if __name__ == '__main__':
    parse = argparse.ArgumentParser('gridplot-kfold2-2layers-tanh.py', description='Multi Layer Perceptron classifier.')
